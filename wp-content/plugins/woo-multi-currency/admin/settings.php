							...
							<td colspan="2">
								...
								<table class="vi-ui  table wmc-currency-options">
									...
									<tr>
										...
										<th class="two wide" colspan="2"><?php esc_html_e( 'Rate + Exchange Fee', 'woo-multi-currency' ) ?>(<a  href="https://goo.gl/yaOf6s"><?php echo esc_html__( 'Update This Feature', 'woo-multi-currency' ) ?></a>)</th>
